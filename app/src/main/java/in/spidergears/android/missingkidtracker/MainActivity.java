        ...
        if(takePictureIntent.resolveActivity(getPackageManager()) != null) {
            try {
                ...
                if(!albumDir.isDirectory() && !albumDir.mkdirs()){
                    Log.e(tag, String.format("Unable to create album directory at [%s]", albumDir));
                    return;
                }
                ...
                Log.e(tag, "Security Exception encountered while creating file for storing image", se);
            }
            catch (Exception e){
